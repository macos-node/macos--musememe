...
# Installation
 ...
 - download [your.spoon](https://github.com/fork-my-spoons/your.spoon/releases/latest/download/your.spoon.zip), unzip and double click on a .spoon file. It will be installed under `~/.hammerspoon/Spoons` folder.
